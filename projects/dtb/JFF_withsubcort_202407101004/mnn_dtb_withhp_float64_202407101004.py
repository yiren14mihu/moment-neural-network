...
import torch
import numpy as np
from projects.dtb.JFF_withsubcort_202407101004.ma_conductance_withhp_float64_202407101004 import Moment_Activation_Cond
...
class Cond_MNN_DTB():
    def __init__(self, config_for_Cond_MNN_DTB, config_for_Moment_exc_activation=None, config_for_Moment_inh_activation=None):
        ...
        K_EE, K_EI, K_IE, K_II, K_EE_long, degree_, block_size = calculate_degree(
            ...
            _EI_ratio=self._EI_ratio, use_cluster=True
    ...
    def run(self, T=None, init_time=None, init_point=None):
