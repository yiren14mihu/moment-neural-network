...
class Moment_Activation_Cond(Mnn_Core_Func):
    ...
    def cond2curr_includingbgOU_withhp_numpy(self, exc_input_mean, exc_input_std, inh_input_mean, inh_input_std, external_current):
        assert isinstance(exc_input_mean, np.ndarray)
    ...
    def cond2curr_includingbgOU_withhp(self, exc_input_mean, exc_input_std, inh_input_mean, inh_input_std, external_current):
        assert isinstance(exc_input_mean, torch.Tensor)
    ...
    def activate_numpy(self, eff_input_mean, eff_input_std, tau_eff):
        # for pytorch
